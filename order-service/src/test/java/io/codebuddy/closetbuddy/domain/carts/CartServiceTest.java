...
class CartServiceTest {
    ...
    void success_createCart() {
        ...
        verify(cartRepository).saveAndFlush(argThat(cart ->
                cart.getMemberId().equals(memberId)
        ));
    ...
    void success_addCartItemToCart_JustUpdateCount() {
        ...
        given(cartItemRepository.findByCartIdAndProductId(cartId, productId)).willReturn(Optional.of(existCartItem));
    ...
    void success_getCartList() {
        ...
        // 병합 검증
        assertThat(testList).extracting("cartItemId", "productId", "productName", "productPrice", "cartCount", "storeName","imageUrl")
