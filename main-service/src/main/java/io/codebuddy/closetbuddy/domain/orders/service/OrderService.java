...
import io.codebuddy.closetbuddy.domain.carts.feign.CartProductClient;
import io.codebuddy.closetbuddy.domain.carts.feign.CartProductResponse;
...
public class OrderService {
    ...
    public Long createOrder(Long memberId, OrderCreateRequestDto requestDto) {
        ...
        for (OrderItemCreateRequestDto itemDto : requestDto.orderItems()) {
            ...
            OrderProductResponse response = orderProductClient.getProduct(itemDto.productId());
    ...
    public Long createOrderFromCart(Long memberId) {
        ...
        for (CartGetResponseDto cartDto : cartList) {
            ...
            CartProductResponse response = cartProductClient.getProduct(cartDto.productId());
