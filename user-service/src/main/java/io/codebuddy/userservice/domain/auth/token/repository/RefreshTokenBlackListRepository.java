package io.codebuddy.userservice.domain.auth.token.repository;

import io.codebuddy.userservice.domain.auth.token.domain.RefreshTokenBlackList;import org.springframework.data.jpa.repository.JpaRepository;
