package io.codebuddy.userservice.domain.auth.token.repository.adapter;
...
import io.codebuddy.userservice.domain.auth.token.domain.RefreshTokenBlackList;
import io.codebuddy.userservice.domain.auth.token.repository.RefreshTokenBlackListRepository;
